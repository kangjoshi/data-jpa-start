...
class MemberRepositoryTest {
    ...
    void projections() {
        ...
        List<UsernameOnly> results = memberRepository.findProjectionsByUsername("m1");

        for (UsernameOnly result : results) {
    ...
    void nativeQuery() {
        ...
        Member findMember = memberRepository.findByNativeQuery(m1.getUsername());
